    ...
    children: [
      {
        ...
        title: "实时监控",
        permission: "monitor:realtime:page",
      },
      {
        id: "statistics",
        path: "/monitoring/statistics",
        title: "统计分析",
        permission: "monitor:statistics:page",
      },
      {
        id: "warningArchive",
        path: "/monitoring/warningArchive",
        title: "预警档案",
        permission: "monitor:warning:archive",
      },
      {
        id: "warningManage",
        path: "/monitoring/warningManage",
        title: "预警管理",
        permission: "monitor:warning:manage",
      },
      {
        id: "intelligentReview",
        path: "/monitoring/intelligentReview",
        title: "智能复判",
        permission: "monitor:review:intelligent",
      },
    ],
  },
  {
    ...
    children: [
      {
        ...
        title: "摄像头",
        permission: "device:camera:page",
      },
      {
        id: "localVideo",
        path: "/deviceManage/localVideo",
        title: "本地视频",
        permission: "device:video:page",
      },
    ],
  },
  {
    ...
    children: [
      {
        ...
        title: "视觉模型技能",
        permission: "skill:device:page",
      },
      {
        id: "multimodalLlmSkills",
        path: "/skillManage/multimodalLlmSkills",
        title: "多模态大模型技能",
        permission: "skill:multimodal:page",
      },
      {
        id: "multimodalReview",
        path: "/skillManage/multimodalReview",
        title: "多模态大模型复判",
        permission: "skill:review:page",
      },
    ],
  },
  {
    ...
    children: [
      {
        ...
        title: "应用设置",
        permission: "system:setting:page",
      },
      {
        id: "userManagement",
    ...
    children: [
      {
        ...
        path: "/visualCenter",
        title: "可视中心首页",
        permission: "visual:center:page",
      },
      {
        id: "algorithmInference",
        path: "/algorithmInference",
        title: "算法推理平台",
        permission: "algorithm:inference:page",
      },
      {
        id: "parkManagement",
        path: "/visualCenter/parkManagement",
        title: "园区封闭管理平台",
        permission: "park:management:page",
      },
    ],
  },
  {
    ...
    children: [
      {
        ...
        title: "边缘服务器",
        permission: "edge:server:page",
      },
      {
        id: "edgeBox",
        path: "/edgeManage/edgeBox",
        title: "边缘盒子",
        permission: "edge:box:page",
      },
    ],
  },
];
...
export const PERMISSION_GROUPS: Record<string, PermissionGroup> = {
  ...
  device: {
    name: "设备管理",
    icon: "el-icon-cpu",
    permissions: ["device:camera:page", "device:camera:manage", "device:video:page"],
  },
  model: {
    name: "模型管理",
    icon: "el-icon-data-analysis",
    permissions: ["model:list:page"],
  },
  skill: {
    name: "技能管理",
    icon: "el-icon-magic-stick",
  ...
  visual: {
    name: "可视中心",
    icon: "el-icon-view",
    permissions: ["visual:center:page", "algorithm:inference:page", "park:management:page"],
  },
  edge: {
    name: "边缘管理",
    icon: "el-icon-share",
    permissions: ["edge:server:page", "edge:box:page"],
  },
  control: {
    name: "智能控制",
    icon: "el-icon-s-operation",
    permissions: ["control:log:page"],
  },
};
