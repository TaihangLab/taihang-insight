...
.role-search-bar .el-form-item {
  margin-bottom: 0;
  margin-right: var(--design-spacing-md);
}

.role-search-bar .el-form-item__label {
  color: var(--design-text-primary);
  font-weight: var(--design-font-weight-medium);
  font-size: var(--design-font-size-sm);
}

.role-search-bar :deep(.el-input__wrapper) {
  border-radius: var(--design-radius-md);
  transition: all var(--design-transition-base);
}

.role-search-bar :deep(.el-input__wrapper:hover) {
  box-shadow: 0 0 0 1px var(--design-primary-color) inset;
}

.role-search-bar :deep(.el-input__wrapper.is-focus) {
  box-shadow: 0 0 0 1px var(--design-primary-color) inset;
}

.role-search-bar :deep(.el-select .el-input__wrapper) {
  width: 140px;
}

.role-search-bar :deep(.el-button) {
  border-radius: var(--design-radius-md);
  font-weight: var(--design-font-weight-medium);
  padding: 8px 20px;
  transition: all var(--design-transition-base);
