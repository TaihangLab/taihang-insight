    ...
    <div class="p-4 flex-1 flex flex-col">
      <div class="mb-5">
        ...
        <div class="flex gap-1">
          <span
            v-for="(digit, index) in deviceTotalDigits"
            :key="index"
        ...
        >
          <div class="w-[60px] h-[60px] relative">
            <div class="absolute inset-0">
              <div
                class="absolute inset-0 border-2 rounded-full animate-pulse"
                style="border-color: #1b96ff"
              ></div>
              <div
                class="absolute inset-0 border-2 rounded-full animate-ping opacity-50"
                style="animation-delay: 0.5s; border-color: #1b96ff"
              ></div>
            </div>
