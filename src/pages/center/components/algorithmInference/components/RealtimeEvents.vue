<template>
  <div
    ...
    style="background: rgba(6, 30, 93, 0.8); border: 1px solid rgba(35, 88, 148, 0.5)"
  >
    <div
      class="px-4 py-3"
      style="background: rgba(4, 20, 63, 0.8); border-bottom: 1px solid rgba(35, 88, 148, 0.3)"
    >
    ...
    <div class="p-4 flex-1 flex flex-col gap-2.5">
      ...
      <div v-else-if="!latestEvent.hasData" class="flex-1 flex flex-col gap-2.5">
        <div
          class="flex-1 min-h-[120px] rounded flex items-center justify-center"
        ...
        <div class="flex gap-1.5 h-[50px]">
          <div
            v-for="i in 3"
            :key="i"
            class="flex-1 rounded flex items-center justify-center"
            style="background: rgba(0, 0, 0, 0.3); border: 1px solid rgba(0, 255, 255, 0.2)"
          >
      ...
      <template v-else>
        <!-- 主图片区域 -->
        <div
          class="flex-1 min-h-[120px] rounded overflow-hidden relative"
          style="background: rgba(0, 0, 0, 0.3); border: 1px solid rgba(0, 255, 255, 0.2)"
        >
          <img
          ...
          <div
            ...
            style="
              background: linear-gradient(
                135deg,
                rgba(27, 150, 255, 0.2) 0%,
                rgba(68, 255, 155, 0.2) 100%
              );
            "
          >
          ...
          <!-- 实时标记 -->
          <div
            class="absolute top-2 left-2 px-2 py-1 rounded text-[10px] font-bold animate-pulse"
