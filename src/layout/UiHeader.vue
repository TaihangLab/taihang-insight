  ...
  methods: {
    ...
    updateBreadcrumb() {
      ...
      const routeMap = {
        ...
        '/monitoring/reviewRecords': { menu: '监控预警', page: '智能复判' },
        ...
        '/skillManage/multimodalCreateDetail': { menu: '技能管理', page: '多模态大模型技能' },
        '/skillManage/multimodalReview': { menu: '技能管理', page: '多模态大模型复判' },
        '/skillManage/multimodalReviewCreate': { menu: '技能管理', page: '多模态大模型复判' },
        '/skillManage/runPlan': { menu: '技能管理', page: '技能运行计划' },
        '/skillManage/skillGraphEditor': { menu: '技能管理', page: '可视化技能编排' },
