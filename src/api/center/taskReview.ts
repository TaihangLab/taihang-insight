...
class TaskReviewAPI {
  ...
  async getTaskReviewConfig(taskType: string, taskId: string | number): Promise<AxiosResponse<UnifiedResponse<TaskReviewConfig>>> {
    ...
    try {
      const response = await visionAIAxios.get(`/api/v1/tasks/${taskType}/${taskId}/review-config`)
  ...
  async updateTaskReviewConfig(taskType: string, taskId: string | number, config: TaskReviewConfig): Promise<AxiosResponse> {
    ...
    try {
      const response = await visionAIAxios.put(`/api/v1/tasks/${taskType}/${taskId}/review-config`, config)
  ...
  async deleteTaskReviewConfig(taskType: string, taskId: string | number): Promise<AxiosResponse> {
    ...
    try {
      const response = await visionAIAxios.delete(`/api/v1/tasks/${taskType}/${taskId}/review-config`)
  ...
  async getAvailableReviewSkills(): Promise<AxiosResponse> {
    ...
    try {
      const response = await visionAIAxios.get('/api/v1/review-skills/available')
  ...
  async getReviewEnabledTasks(): Promise<AxiosResponse> {
    ...
    try {
      const response = await visionAIAxios.get('/api/v1/tasks/review-enabled')
  ...
  async triggerAlertReview(alertId: number): Promise<AxiosResponse> {
    ...
    try {
      const response = await visionAIAxios.post('/api/v1/alerts/review', { alert_id: alertId })
  ...
  async getReviewServiceStatus(): Promise<AxiosResponse> {
    ...
    try {
      const response = await visionAIAxios.get('/api/v1/review-service/status')
  ...
  async startReviewService(): Promise<AxiosResponse> {
    ...
    try {
      const response = await visionAIAxios.post('/api/v1/review-service/start')
  ...
  async stopReviewService(): Promise<AxiosResponse> {
    ...
    try {
      const response = await visionAIAxios.post('/api/v1/review-service/stop')
  ...
  async getAITasksForReview(params: Record<string, any> = {}): Promise<AxiosResponse> {
    ...
    try {
      const response = await visionAIAxios.get('/api/v1/ai-tasks', { params })
