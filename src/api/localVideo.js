...
export function startVideoStream(videoId, data) {
  return request({
    url: `/api/local-videos/${videoId}/start-stream`,
    method: 'post',
    data: data,
    baseURL: apiConfig.API_BASE_URL
  })
...
export function stopVideoStream(videoId) {
  return request({
    url: `/api/local-videos/${videoId}/stop-stream`,
    method: 'post',
    baseURL: apiConfig.API_BASE_URL
  })
}
...
export function getVideoStreamStatus(videoId) {
  return request({
    url: `/api/local-videos/${videoId}/stream-status`,
    method: 'get',
    baseURL: apiConfig.API_BASE_URL
  })
}
