...
export function getRecordList(deviceId, channelId, params) {
  return request({
    url: `/api/record/list/${deviceId}/${channelId}`,
    method: 'get',
    params: params
  })
}
...
export function downloadRecord(deviceId, channelId, params) {
  return request({
    url: `/api/record/download/${deviceId}/${channelId}`,
    method: 'get',
    params: params
  })
}
...
export function getDownloadProgress(downloadId) {
  return request({
    url: `/api/record/download/progress/${downloadId}`,
    method: 'get'
  })
}
