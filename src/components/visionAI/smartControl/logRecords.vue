...
/* 清空日志按钮与重置按钮保持一致的样式 */
.table-operations :deep(.el-button--danger) {
  background: #f5f7fa;
  border-color: #e4e7ed;
  color: #606266;
  border-radius: 8px;
...
.table-operations :deep(.el-button--danger:hover) {
  background: linear-gradient(135deg, #eff6ff 0%, #dbeafe 100%);
  border-color: #3b82f6;
  color: #1e3a8a;
  box-shadow: 0 2px 8px rgba(59, 130, 246, 0.2);
...
/* ===== 标签样式 - 完全参照camera.css ===== */
/* 类型标签 - 灰底灰字 */
.log-records-container :deep(.el-table .el-tag[type=""]),
.log-records-container :deep(.el-dialog .el-tag[type=""]) {
...
/* 状态标签 - 科技感浅色 */
.log-records-container :deep(.el-table .el-tag--success),
.log-records-container :deep(.el-dialog .el-tag--success) {
...
.log-records-container :deep(.el-table .el-tag--danger),
.log-records-container :deep(.el-dialog .el-tag--danger) {
...
.log-records-container :deep(.el-table .el-tag--warning),
.log-records-container :deep(.el-dialog .el-tag--warning) {
...
.log-records-container :deep(.el-table .el-tag--info),
.log-records-container :deep(.el-dialog .el-tag--info) {
  background: linear-gradient(135deg, #eff6ff 0%, #dbeafe 100%) !important;
...
/* 统一表格内所有标签样式 */
.log-records-container :deep(.el-table .el-tag),
.log-records-container :deep(.el-dialog .el-tag) {
  border-radius: 6px !important;
  font-weight: 500 !important;
  font-size: 12px !important;
  padding: 0 8px !important;
...
.log-records-container :deep(.el-table .el-tag:hover),
.log-records-container :deep(.el-dialog .el-tag:hover) {
  transform: translateY(-1px) !important;
...
/* ===== 弹框样式 - 完全参照camera.css ===== */
.log-records-container :deep(.el-dialog) {
  border-radius: 12px !important;
  overflow: hidden !important;
  box-shadow: 0 10px 40px rgba(0, 0, 0, 0.1) !important;
}

.log-records-container :deep(.el-dialog__header) {
  background: linear-gradient(135deg, #f8fafc 0%, #f1f5f9 100%) !important;
  border-bottom: 1px solid rgba(59, 130, 246, 0.1) !important;
  padding: 16px 20px !important;
}

.log-records-container :deep(.el-dialog__title) {
  color: #1f2937 !important;
  font-weight: 600 !important;
}

.log-records-container :deep(.el-dialog__close) {
  color: #6b7280 !important;
  transition: color 0.3s ease !important;
}

.log-records-container :deep(.el-dialog__close:hover) {
  color: #3b82f6 !important;
}

.log-records-container :deep(.el-dialog__body) {
  padding: 20px !important;
  background: #ffffff !important;
}

.log-records-container :deep(.el-dialog__footer) {
...
/* 弹框内按钮样式 */
.log-records-container :deep(.el-dialog .el-button--primary) {
...
.log-records-container :deep(.el-dialog .el-button--primary:hover) {
  background: linear-gradient(135deg, #1d4ed8 0%, #1e3a8a 100%) !important;
  box-shadow: 0 4px 10px rgba(59, 130, 246, 0.4) !important;
  transform: translateY(-1px) !important;
}

.log-records-container :deep(.el-dialog .el-button--default) {
...
.log-records-container :deep(.el-dialog .el-button--default:hover) {
  background: linear-gradient(135deg, #eff6ff 0%, #dbeafe 100%) !important;
  border-color: #3b82f6 !important;
  color: #1e40af !important;
...
.log-records-container :deep(.el-dialog .el-button--danger) {
...
.log-records-container :deep(.el-dialog .el-button--danger:hover) {
...
/* MessageBox 弹框整体样式 */
.log-records-container :deep(.el-message-box) {
  border-radius: 12px !important;
  overflow: hidden !important;
...
/* MessageBox 头部样式 */
.log-records-container :deep(.el-message-box__header) {
  background: linear-gradient(135deg, #f8fafc 0%, #f1f5f9 100%) !important;
  border-bottom: 1px solid rgba(59, 130, 246, 0.1) !important;
  padding: 16px 20px !important;
}
...
/* MessageBox 标题样式 */
.log-records-container :deep(.el-message-box__title) {
  color: #1f2937 !important;
  font-weight: 600 !important;
...
/* MessageBox 关闭按钮 */
.log-records-container :deep(.el-message-box__close) {
  color: #6b7280 !important;
  transition: color 0.3s ease !important;
}

.log-records-container :deep(.el-message-box__close:hover) {
  color: #3b82f6 !important;
}

/* MessageBox 主体内容样式 */
.log-records-container :deep(.el-message-box__content) {
  padding: 20px !important;
  background: #ffffff !important;
}

/* MessageBox 消息文本样式 */
.log-records-container :deep(.el-message-box__message) {
...
/* MessageBox 图标样式 */
.log-records-container :deep(.el-message-box__status) {
  font-size: 20px !important;
}

.log-records-container :deep(.el-message-box__status.el-icon-warning) {
  color: #f59e0b !important;
}

.log-records-container :deep(.el-message-box__status.el-icon-info) {
  color: #3b82f6 !important;
}

.log-records-container :deep(.el-message-box__status.el-icon-success) {
  color: #10b981 !important;
}

.log-records-container :deep(.el-message-box__status.el-icon-error) {
  color: #ef4444 !important;
}

/* MessageBox 底部按钮区域 */
.log-records-container :deep(.el-message-box__btns) {
  padding: 10px 20px 20px !important;
  text-align: right !important;
  border-top: 1px solid rgba(59, 130, 246, 0.1) !important;
  background: linear-gradient(135deg, #f8fafc 0%, #f1f5f9 100%) !important;
...
/* MessageBox 按钮样式 */
.log-records-container :deep(.el-message-box__btns .el-button--primary) {
  background: linear-gradient(135deg, #3b82f6 0%, #1e40af 100%) !important;
  border: none !important;
  box-shadow: 0 2px 6px rgba(59, 130, 246, 0.3) !important;
  color: white !important;
...
.log-records-container :deep(.el-message-box__btns .el-button--primary:hover) {
  background: linear-gradient(135deg, #1d4ed8 0%, #1e3a8a 100%) !important;
  box-shadow: 0 4px 10px rgba(59, 130, 246, 0.4) !important;
  transform: translateY(-1px) !important;
}

.log-records-container :deep(.el-message-box__btns .el-button--default) {
  background: white !important;
  border: 1px solid #d1d5db !important;
  color: #4b5563 !important;
  transition: all 0.3s ease !important;
...
.log-records-container :deep(.el-message-box__btns .el-button--default:hover) {
  background: linear-gradient(135deg, #eff6ff 0%, #dbeafe 100%) !important;
  border-color: #3b82f6 !important;
  color: #1e40af !important;
  box-shadow: 0 2px 4px rgba(59, 130, 246, 0.2) !important;
...
/* 危险操作按钮样式 (删除确认等) */
.log-records-container :deep(.el-message-box__btns .el-button--danger) {
  background: linear-gradient(135deg, #f56c6c 0%, #e53e3e 100%) !important;
  border: none !important;
  box-shadow: 0 2px 6px rgba(245, 108, 108, 0.3) !important;
  color: white !important;
...
.log-records-container :deep(.el-message-box__btns .el-button--danger:hover) {
  background: linear-gradient(135deg, #e53e3e 0%, #c53030 100%) !important;
  box-shadow: 0 4px 10px rgba(245, 108, 108, 0.4) !important;
  transform: translateY(-1px) !important;
}
