  ...
  <div id="recordDetail" style="width: 100%">
    <div class="page-header" style="margin-bottom: 0">
      ...
      <div
        ...
        v-if="!this.$route.params.mediaServerId"
        ...
        <div class="record-list-box-box">
          ...
          <div class="record-list-box" :style="recordListStyle">
            <ul
              ...
              class="infinite-list record-list"
            ...
            <ul class="task-list">
              <li class="task-list-item" v-for="(item, index) in taskListForRuning" :key="index">
                <div class="task-list-item-box">
                  ...
                  <el-progress
                    :percentage="(parseFloat(item.percentage) * 100).toFixed(1)"
                  ></el-progress>
                </div>
              </li>
            </ul>
              ...
              <li class="task-list-item" v-for="(item, index) in taskListEnded" :key="index">
                <div class="task-list-item-box" style="height: 2rem; line-height: 2rem">
                  ...
                  <a
                    ...
                    :href="getFileBasePath() + '/download.html?url=download/'"
                    target="_blank"
                  ></a>
                </div>
              </li>
...
export default {
  ...
  mounted() {
    ...
    this.getDateInYear(() => {
      if (Object.values(this.dateFilesObj).length > 0) {
        this.chooseDate = Object.values(this.dateFilesObj)[
          Object.values(this.dateFilesObj).length - 1
        ];
        this.dateChange();
      }
    });
  ...
  methods: {
    dateChange() {
      ...
      if (
        chooseFullDate.getFullYear() !== this.queryDate.getFullYear() ||
      ...
      this.queryRecordDetails(() => {
        if (this.detailFiles.length > 0) {
          ...
          let timeNum =
            timeForFile[0].getTime() - new Date(this.chooseDate + " " + this.timeFormat).getTime();
          console.log(timeNum);
          let lastTimeNum =
            lastTimeForFile[1].getTime() -
            new Date(this.chooseDate + " " + this.timeFormat).getTime();
    ...
    addTask() {
      ...
      let endTimeStr =
        this.chooseDate +
        " " +
        this.detailFiles[this.detailFiles.length - 1].fileName.substring(9, 17);
