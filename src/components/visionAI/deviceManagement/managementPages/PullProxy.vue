      ...
      <div class="page-header management-page-header">
        ...
        <div class="header-right">
          ...
          <el-button
            ...
            @click="handleRefresh"
            :loading="getStreamProxyListLoading"
          >
            刷新列表
          </el-button>
        </div>
...
<div  class="card-header">
          ...
          >
            ...
            <el-table-column label="拉流状态" width="100" align="center">
              <template #default="{ row }">
                <el-tag
                  size="medium"
                  v-if="row.pulling && Vue.prototype.$myServerId !== row.serverId"
            ...
            <el-table-column label="启用状态" width="100" align="center">
              <template #default="{ row }">
                <el-tag
                  size="medium"
                  v-if="row.enable && Vue.prototype.$myServerId !== row.serverId"
                  style="border-color: #ecf1af"
                >
                  已启用
                </el-tag>
            ...
            <el-table-column label="操作" width="350" fixed="right" align="center">
              <template #default="{ row }">
                <div class="operation-buttons">
                  ...
                  <el-button size="small" icon="el-icon-edit" type="warning" @click="edit(row)">
                    编辑
                  </el-button>
                  <el-button
                    size="small"
        ...
        <div v-if="viewMode === 'card'" class="proxy-cards">
          <el-card
            v-for="proxy in streamProxyList"
            :key="proxy.id"
            class="proxy-card"
            shadow="hover"
          >
            ...
            <div class="proxy-card-content">
              ...
              <div class="proxy-info-row">
                ...
                <span class="info-value">
                  {{ proxy.type === "default" ? "默认" : "FFMPEG代理" }}
                </span>
              </div>
            ...
            <div class="proxy-card-actions">
              ...
              <el-button size="small" icon="el-icon-edit" type="warning" @click="edit(proxy)">
                编辑
              </el-button>
              <el-button
                size="small"
...
export default {
  ...
  methods: {
    ...
    play(row) {
      ...
      startStreamProxyById(row.id, this.mediaServerId)
        .then((data) => {
    ...
    stopPlay(row) {
      stopStreamProxyById(row.id, this.mediaServerId)
        .then(() => {
    ...
    deleteStreamProxy(row) {
      this.$confirm("确定删除此代理吗？", "提示", {
        ...
        .then(() => {
          deleteStreamProxyById(row.id, this.mediaServerId)
            .then((res) => {
              this.$message.success({
                showClose: true,
                message: "删除成功",
