    ...
    >
      <div id="formStep" style="margin-top: 1rem; margin-right: 20px">
        <el-form
          ...
          ref="mediaServerForm"
          :rules="rules"
          :model="mediaServerForm"
          label-width="140px"
        >
          <el-form-item label="IP" prop="ip">
            <el-input
              v-model="mediaServerForm.ip"
              placeholder="媒体服务IP"
              clearable
          ...
          <el-form-item label="HTTP端口" prop="httpPort">
            <el-input
              v-model="mediaServerForm.httpPort"
              placeholder="媒体服务HTTP端口"
              clearable
              :disabled="mediaServerForm.defaultServer"
            ></el-input>
          </el-form-item>
          <el-form-item label="SECRET" prop="secret">
            <el-input
              v-model="mediaServerForm.secret"
              placeholder="媒体服务SECRET"
              clearable
              :disabled="mediaServerForm.defaultServer"
            ></el-input>
          </el-form-item>
          ...
          <el-form-item>
            <div style="float: right">
              <el-button type="primary" v-if="currentStep === 1 && serverCheck === 1" @click="next">
                下一步
              </el-button>
          ...
          <el-col :span="12">
            ...
            >
              ...
              <el-form-item label="HOOK IP" prop="ip">
                <el-input
                  v-model="mediaServerForm.hookIp"
                  placeholder="媒体服务HOOK_IP"
                  clearable
                  :disabled="mediaServerForm.defaultServer"
                ></el-input>
              </el-form-item>
              <el-form-item label="SDP IP" prop="ip">
                <el-input
                  v-model="mediaServerForm.sdpIp"
                  placeholder="媒体服务SDP_IP"
                  clearable
                  :disabled="mediaServerForm.defaultServer"
                ></el-input>
              </el-form-item>
              <el-form-item label="流IP" prop="ip">
                <el-input
                  v-model="mediaServerForm.streamIp"
                  placeholder="媒体服务流IP"
                  clearable
                  :disabled="mediaServerForm.defaultServer"
                ></el-input>
              ...
              <el-form-item label="HTTPS PORT" prop="httpSSlPort">
                <el-input
                  v-model="mediaServerForm.httpSSlPort"
              ...
              <el-form-item label="RTSP PORT" prop="rtspPort">
                <el-input
                  v-model="mediaServerForm.rtspPort"
                  placeholder="媒体服务RTSP_PORT"
                  clearable
                  :disabled="mediaServerForm.defaultServer"
                ></el-input>
              </el-form-item>
              <el-form-item label="RTSPS PORT" prop="rtspSSLPort">
                <el-input
                  v-model="mediaServerForm.rtspSSLPort"
          ...
          <el-col :span="12">
            ...
            >
              <el-form-item label="RTMP PORT" prop="rtmpPort">
                <el-input
                  v-model="mediaServerForm.rtmpPort"
                  placeholder="媒体服务RTMP_PORT"
                  clearable
                  :disabled="mediaServerForm.defaultServer"
                ></el-input>
              </el-form-item>
              <el-form-item label="RTMPS PORT" prop="rtmpSSlPort">
                <el-input
                  v-model="mediaServerForm.rtmpSSlPort"
              ...
              <el-form-item label="自动配置媒体服务">
                <el-switch
                  v-model="mediaServerForm.autoConfig"
                  :disabled="mediaServerForm.defaultServer"
                ></el-switch>
              </el-form-item>
              ...
              <el-form-item v-if="!mediaServerForm.rtpEnable" label="收流端口" prop="rtpProxyPort">
                <el-input
                  v-model.number="mediaServerForm.rtpProxyPort"
                  clearable
                  :disabled="mediaServerForm.defaultServer"
                ></el-input>
              </el-form-item>
              ...
              <el-form-item label="录像管理服务端口" prop="recordAssistPort">
                <el-input
                  v-model.number="mediaServerForm.recordAssistPort"
                  :disabled="mediaServerForm.defaultServer"
                >
...
<el-button
                ...
                <i
                  v-if="recordServerCheck === -1"
                  class="el-icon-error"
                  style="color: #c80000; position: absolute; top: 14px"
                ></i>
              </el-form-item>
              <el-form-item>
                <div style="float: right">
                  <el-button v-if="!mediaServerForm.defaultServer" type="primary" @click="onSubmit">
                    提交
                  </el-button>
...
export default {
  ...
  data() {
    ...
    return {
      ...
      rules: {
        ip: [
          { required: true, validator: isValidIp, message: "请输入有效的IP地址", trigger: "blur" },
        ],
        httpPort: [
          {
            required: true,
  ...
  methods: {
    ...
    checkRecordServer: function () {
      ...
      if (
        ...
        that.mediaServerForm.recordAssistPort > 65535
      ) {
    ...
    portRangeChange: function () {
      if (this.mediaServerForm.rtpEnable) {
        ...
        this.mediaServerForm.sendRtpPortRange =
          this.sendRtpPortRange1 + "," + this.sendRtpPortRange2;
      }
    },
  },
};
