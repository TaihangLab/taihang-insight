  ...
  <div class="media-server-manager management-page-container">
    ...
    <div class="page-header management-page-header">
      ...
      <div class="header-right">
        <el-button type="primary" icon="el-icon-plus" @click="add">添加节点</el-button>
        <el-button type="success" icon="el-icon-refresh" @click="initData">刷新列表</el-button>
      </div>
    </div>
    ...
    <div class="stats-cards management-stats-cards">
        ...
        <div class="stat-content">
          ...
          <div class="stat-info">
            <div class="stat-number">
              {{ mediaServerList.filter((item) => item.status).length }}
            </div>
      ...
      <el-card class="stat-card management-stat-card" shadow="hover">
        <div class="stat-content">
          ...
          <div class="stat-info">
            <div class="stat-number">
              {{ mediaServerList.filter((item) => item.defaultServer).length }}
            </div>
