  ...
  <div class="visual-center" ref="visualCenter">
    <div class="top-bar">
      <div class="top-bar-inner">
        <div class="top-bar-nav top-bar-nav-left">
          <span
            v-for="item in headerNavLeft"
            :key="item.key"
            class="nav-item"
            :class="{ active: activeHeaderNav === item.key }"
            @click="handleHeaderNavClick(item)"
          >{{ item.label }}</span>
        </div>
    ...
    <div class="main-content">
      ...
      <!-- 底部表格 -->
      <el-row class="bottom-section" :gutter="16">
        <el-col :span="6">
...
.time-tabs >>> .el-radio-button__inner {
  ...
  border-color: rgba(129, 248, 255, 0.35);
...
.fullscreen-btn {
  ...
  border: 1px solid rgba(129, 248, 255, 0.35);
  border-radius: 4px;
  color: #81f8ff;
  font-size: 14px;
  cursor: pointer;
...
.visual-center:fullscreen .top-bar-inner,
.visual-center:-webkit-full-screen .top-bar-inner,
...
.visual-center:fullscreen .top-bar-datetime,
.visual-center:-webkit-full-screen .top-bar-datetime,
.visual-center:-moz-full-screen .top-bar-datetime,
.visual-center:-ms-fullscreen .top-bar-datetime {
  left: 20px;
  top: 33px;
}
...
.visual-center:-ms-fullscreen .main-content {
  ...
  margin: 0 !important;
  padding: 62px 12px 8px 12px !important;
