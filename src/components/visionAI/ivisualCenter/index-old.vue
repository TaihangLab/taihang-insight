                ...
                <div class="warning-info-overlay">
                  <div class="warning-info-panel">
                    ...
                    <div class="info-row">
                      ...
                      <span class="info-value" :class="'level-' + currentWarningImage.level">
                        {{ currentWarningImage.levelText }}
                      </span>
                    </div>
                    <div class="info-row">
...
export default {
  ...
  mounted() {
    ...
    this.dataRefreshTimer = setInterval(this.loadAllStatistics, 30 * 1000); // 每30秒刷新统计数据
  ...
  methods: {
    ...
    initMockData() {
      ...
      this.warningList = [
        ...
        {
          event: "违规吸烟",
          time: "2024-01-15 07:58:42",
          status: "completed",
          statusText: "已完成",
        },
        {
          event: "高空作业未系安全带",
          time: "2024-01-15 07:15:28",
          status: "processing",
          statusText: "处理中",
        },
      ];
...
.map-panel {
  height: calc(
    var(--panel-top-height) + 52px + var(--panel-top-height) - 30px
  ); /* 精确对齐：上面板 + 间距 + 下面板 */
