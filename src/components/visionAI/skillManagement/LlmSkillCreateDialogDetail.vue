          ...
          <div class="skill-details">
            ...
            <div class="skill-meta">
              ...
              <el-tag size="small" type="primary">
                {{ skillInfo.scenario === "vision" ? "视频分析" : "图片处理" }}
              </el-tag>
            ...
            <div class="prompt-section">
              ...
              <div class="prompt-editor">
                <div class="prompt-header">
                  <span>提示词模板</span>
                  <el-button link size="small" @click="useTemplate" class="template-btn">
                    使用模板
                  </el-button>
                </div>
        ...
        <div class="bottom-content">
          <div class="config-section">
            ...
            <div class="config-group">
              ...
              <div class="param-help">配置AI分析后的输出参数，这些参数将用于后续的预警条件判断</div>
              <div class="output-params">
                ...
                <div class="param-list">
                  <div v-for="(param, index) in outputParams" :key="index" class="param-item">
                    ...
                    <div class="param-field">
                      <el-select v-model="param.type" placeholder="选择类型" size="small">
            ...
            <div class="config-group">
              ...
              <div class="warning-conditions-new">
                <div class="condition-description">
                  ...
                  <el-select v-model="globalRelation" size="small" class="relation-select">
                    ...
                    <div class="conditions-list">
                      ...
                      >
                        ...
                        <div class="condition-field">
                          ...
                          <el-input-number
                            v-else-if="
                              (getSelectedParamType(condition.field) === 'int' ||
                                getSelectedParamType(condition.field) === 'float') &&
                              ['gt', 'gte', 'lt', 'lte', 'eq', 'ne'].includes(condition.operator)
                            "
                            v-model="condition.value"
                            size="small"
                          ...
                          <el-input
                            ...
                            :placeholder="
                              getValuePlaceholder(
                                condition.operator,
                                getSelectedParamType(condition.field),
                              )
                            "
                            size="small"
                            :disabled="
