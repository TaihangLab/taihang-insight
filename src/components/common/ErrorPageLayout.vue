  ...
  <div class="error-page-container">
    <div class="error-page-content">
      ...
      <div class="decoration-area">
        <div class="error-code-bg">{{ bgCode || errorCode }}</div>
      </div>
      ...
      <div class="info-area">
        ...
        <div class="error-description">
          ...
          <p v-if="submessage" class="error-submessage">{{ submessage }}</p>
        </div>

        <!-- 可能的原因 -->
        <div v-if="reasons.length > 0" class="error-reasons">
        ...
        <div class="error-actions">
          ...
          >
            <i :class="action.icon" class="btn-icon"></i>
            {{ action.label }}
          </button>
        </div>

        <!-- 底部帮助信息 -->
        <div v-if="footerInfo" class="error-footer">
